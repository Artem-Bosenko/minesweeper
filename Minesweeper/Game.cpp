...
void Game::game()
{
	...
	while (app.isOpen())
	{
		...
		while (app.pollEvent(event))
		{
			...
			//Áûëà íàæàòà êíîïêà ìûøè?
			if (event.type == Event::MouseButtonPressed)
				//Åñëè ýòî - ëåâàÿ êíîïêà ìûøè, òî îòêðûâàåì êëåòêó
			...
			//Åñëè ýòî  ïðàâàÿ êíîïêà ìûøè, òî îòîáðàæàåì ôëàæîê
